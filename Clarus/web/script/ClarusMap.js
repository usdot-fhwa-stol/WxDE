...
var m_oMarkerCompare =
{
	compare : function(oMarkerL, oMarkerR)
	{
		...
		if (oStationL.lt < oStationR.lt)
			return -1;

		if (oStationL.lt > oStationR.lt)
			return 1;

		if (oStationL.ln < oStationR.ln)
			return -1;
...
{
	var bMobile = document.getElementById("chMobile").checked;
	...
	while (nIndex-- > 0)
	{
		...
		if ((bMobile && oMarker.m_oStation.ca == "M") || (bFixed && oMarker.m_oStation.ca != "M"))
		{
				oMarker.show();
