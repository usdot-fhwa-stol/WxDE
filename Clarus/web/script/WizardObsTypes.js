...
function onLoad()
{
	...
	m_oTestLabels["clarus.qchs.algo.Barnes"] = "Barnes Spatial";
	m_oTestLabels["clarus.qchs.algo.ClimateRange"] = "Climate Range";
	m_oTestLabels["clarus.qchs.algo.Complete"] = "Complete";
	m_oTestLabels["clarus.qchs.algo.Dewpoint"] = "Dew Point";
	m_oTestLabels["clarus.qchs.algo.IQR"] = "IQR";
	m_oTestLabels["clarus.qchs.algo.LikeInstrument"] = "Like Instrument";
	m_oTestLabels["clarus.qchs.algo.Maintenance"] = "Manual Flag";
	m_oTestLabels["clarus.qchs.algo.Persistence"] = "Persistence";
	m_oTestLabels["clarus.qchs.algo.PrecipAccum"] = "Precip Accum";
	m_oTestLabels["clarus.qchs.algo.SensorRange"] = "Sensor Range";
	m_oTestLabels["clarus.qchs.algo.Sounding"] = "Sea Level Pressure";
	m_oTestLabels["clarus.qchs.algo.Step"] = "Step Test";
...
function cbGetObsTypes(oXml, oText)
{
    ...
    var oRow;
    ListboxInsertItem(oSelect, "All Observations", "");
...
function ObsTypeChanged()
{
    ...
    else
    {
        ...
        oXmlRequest.getXml("listQualityChecks.jsp", cbGetQualityChecks);
    }
}
...
function Validate()
{
    ...
    var oObs = document.getElementById("obs");
    oObs.value = ",,";
    ...
    if (nIndex > 0)
    {
        ...
        // The second comma separator is always added to allow a max
        // to be specified without a min
        sObs += ",";    
