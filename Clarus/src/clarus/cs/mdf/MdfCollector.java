...
import clarus.cs.ascii.CsvCollector;
import clarus.cs.ascii.CsvSvc;
import clarus.cs.ascii.DataValue;
import util.Text;
...
public class MdfCollector extends CsvCollector
{
		...
		String sFilepath, CsMgr oCsMgr, CsvSvc oCsvSvc, Connection iConnection)
	{
		...
		(
			...
			nTimestampId, nSkipLines, sDelimiter, sNewline, sStationCode,
			sFilepath,	oCsMgr, oCsvSvc, iConnection
		);
	}
