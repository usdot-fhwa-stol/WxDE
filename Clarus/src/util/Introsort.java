 ...
 * when this degenerate case is detected, heap-sort and insertion sort take
 * over to avoid this worst case. Operates in the worst case O(nlgn).
 *
 * <p>
...
public class Introsort
{
	...
	/**
	 * Calculates a recursion depth and uses introsort for that depth, then
	 * uses insertion sort for the remaining unordered portion of the list.
	 * @param <T> template type.
	 * @param iList list to sort.
	 ...
	 * <p>
	 * Ex: given a value of 17, and a grid size (precision) of 5, the
	 * value would be mapped into index 15.
	 * </p>
