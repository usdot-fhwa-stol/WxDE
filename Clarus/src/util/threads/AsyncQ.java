...
/**
 * Asynchronous queue object processing. Objects are processed as soon as
 * they are added to the queue.
 *
 * @param <T> template type. Must be specified when creating a new instance
 * of {@code AsyncQ}.
...
public class AsyncQ<T> implements Runnable, IRunTarget<T>
{
     ...
     */
	private Executor m_oThreadPool = ThreadPool.getInstance();
	...
	/**
	 * Creates a new instance of AsyncQ with the defined run target
	 * and the specified thread queue depth.
	 *
