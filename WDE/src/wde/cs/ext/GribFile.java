 ...
 */
public class GribFile implements Runnable
{
	/**
	...
	*/
	...
	private static final GribFile g_oGribFile = new GribFile();
	...
	/**
	 * Returns a reference to singleton GribFile data cache.
	 *
	 * @return reference to RTMA instance.
	 */
	public static GribFile getInstance()
	{
		return g_oGribFile;
	}
...
//			return Double.NaN; // requested time outside of buffered time range
	...
	public static void main(String[] sArgs)
		throws Exception
	{
		GribFile oGribFile = GribFile.getInstance();
		double dVal = oGribFile.getReading(5733, 0, 38000000, -95000000);
