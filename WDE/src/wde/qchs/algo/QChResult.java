...
/**
 * Container of quality check results. Can be used as an interface for
 * passing results back to the calling method of the quality check.
 */
public class QChResult {
    /**
