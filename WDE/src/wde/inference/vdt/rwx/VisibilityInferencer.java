...
public class VisibilityInferencer extends AbstractVdtInferencer {
    ...
    public InferenceResult doInference(VdtObservationResolver resolver) {
        ...
        int visibiltiyCode = rwx.visibility_assessment(precipTypeValue, precipTypeConf, precipIntensityValue, precipIntensityConf, confidenceHolder);

        VisibilityInferenceResult result = (VisibilityInferenceResult) RwxInferenceResultFactory.newVisibilityInferenceResult();
        Visibility visibility = Visibility.fromCode(visibiltiyCode);
