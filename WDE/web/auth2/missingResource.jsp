...
<body>
	...
	<div class="container clearfix">
		...
		<div class="col-2" id="resources">
			<h3>Resource Type</h3>
			<p><i class="icon-exclamation-sign"></i> <%=Encode.forHtml(request.getParameter("resource"))%></p>
		</div>
		<div class="col-2" id="resources">
			<h3>Resource Name</h3>
      <p><i class="icon-exclamation-sign"></i> <%=Encode.forHtml( request.getParameter("id"))%></p>
		</div>
		<div class="col-4" id="instructions">
			<h3>Instructions</h3>
			<p>
				The
        <%=Encode.forHtml( request.getParameter("resource"))%>
