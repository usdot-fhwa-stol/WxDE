...
<head>
    ...
    <jsp:include page="/inc/main-wxde-ui/headers-and-styles.jsp">
    	<jsp:param value="Terms of Use" name="title"/>
    </jsp:include>
...
<body id="aboutPage">
	...
	<h1>Terms of Use</h1>
		...
		<ol>
			<li>Where the contributed materials have been used to any
				...
				<ol style="list-style-type: lower-alpha;">
					<li>In publications, reference the WxDE Web site and the
						...
						processing tool.</li>
					<li>In presentations or other oral communication, by noting
		...
		<p>It is the intent of the USDOT that data residing on the
			...
			Site Manager (use the "Feedback" feature on the WxDE Web site) and
		...
		<p>
			<button class="back-to-top btn-signin btn-dark pull-right">
				<img src="/image/icons/light/fa-arrow-up.png" style="margin-bottom: -1px;" alt="Back to Top Icon" /> 
				Back to top
			</button>
		</p>
