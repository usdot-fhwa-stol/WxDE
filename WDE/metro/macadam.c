...
[I double* dpAH : interpolated absolute humidity
[I double* dpTimeO : steps of 30 seconds for the observation] 
[I long* npSwo : boolean field to check if deep road temperature, air temp, dew point, and wind speed passed QA/QC
